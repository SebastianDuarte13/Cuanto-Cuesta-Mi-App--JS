        ...
        this.questions = [
            {
                ...
                options: [
                    { value: 'android', label: 'Aplicación Android', price: 500, img: '/images/IMG3/answer-3-1.png' },
                    { value: 'ios', label: 'Aplicación iOS', price: 700, img: '/images/IMG3/answer-3-2.png' },
                    { value: 'windows', label: 'Aplicación Windows Phone', price: 400, img: '/images/IMG3/answer-3-3.png' },
                    { value: 'hybrid', label: 'Aplicación Android + iOS', price: 1200, img: '/images/IMG3/answer-3-4.png' }
                ]
            },
            {
                id: 'quality',
                ...
                options: [
                    { value: 'optimal', label: 'Calidad óptima', price: 800, img: '/images/pag2/img-1-2.png' },
                    { value: 'balanced', label: 'Buena relación calidad-precio', price: 400, img: '/images/pag2/img-2-2.png' },
                    { value: 'basic', label: 'No me importa tanto la calidad', price: 0, img: '/images/pag2/answer-3-2.png' }
                ]
            },
            {
                id: 'design',
